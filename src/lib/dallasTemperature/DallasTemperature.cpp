...
DallasTemperature::DallasTemperature() : ClassState("DallasTemperature")
{
#if REQUIRESALARMS
	setAlarmHandler(NO_ALARM_HANDLER);
#endif
}
DallasTemperature::DallasTemperature(OneWire *_oneWire) : ClassState("DallasTemperature")
{
	setOneWire(_oneWire);
#if REQUIRESALARMS
	setAlarmHandler(NO_ALARM_HANDLER);
